...
res_Ir2 = 0;
for i=1:ws_end
    res_Ir2 = res_Ir2 + buff_Im2(i)*sin( 2*pi*f* (t_Im2 - (i-1)*SampleTime) ) * SampleTime;%time in cos goes back
end

res = buff_Im2(1)*cos(2*pi*f*(t_Im2)) - buff_Im2(ws_end)*cos(2*pi*f* (t_Im2 - (SampleTime*ws_end))) + (2*pi*f)*res_Ir2;
